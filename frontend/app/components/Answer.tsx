...
export default function Answer({
  ...
  return (
    ...
    >
      ...
      >
        <svg width="18" height="12" viewBox="0 0 18 11" fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg">
      ...
      <Grid2 container size="grow" sx={{ "& pre, & code": { fontFamily: "CascadiaCode" }}}>
      {thought_and_answer ?
        <Fragment>
        {thought &&
          <Grid2 container direction="column" alignItems="flex-start" sx={{color: "#898E94"}}>
            <ReactMarkdown
      ...
      isAnswering ?
        <CircularProgress size={34} sx={{marginTop: "12px"}} /> :
        <Typography variant='caption' sx={{mt: 2, color: "#898E94"}}>[Aborted]</Typography>
      }{(thought_and_answer == false) && tasksNum > 0 && isAnswering &&
